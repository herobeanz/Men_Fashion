...
namespace FashionShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,ProductPrice,ProductDiscount,ProductPhoto,CategoryId,SizeId,ColorId,IsTrandy,IsArrived")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductDescription,ProductPrice,ProductDiscount,ProductPhoto,CategoryId,SizeId,ColorId,IsTrandy,IsArrived")] Product product)
        {
